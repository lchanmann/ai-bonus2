...
public class ResultData {
	...
	public ISearchResult aStar;
	public ISearchResult hillClimbing;
	public ISearchResult simulatedAnnealing;
	
	public ResultData(){
		
	}
	
	public ResultData(ISearchResult aStar,
            ISearchResult hillClimbing, ISearchResult simulatedAnnealing) {
        this.aStar = aStar;
